-- Keep provider selection independent from channel/acquisition filtering.
-- The prior 10-argument RPC remains available for older deployed clients;
-- this overload adds p_provider for the new All / Interakt / IndiaMART toggle.
  ...
  with base as materialized (
    ...
    where s.organization_id = p_organization_id
      ...
      and (
        ...
        or s.source_provider = p_provider
      )
