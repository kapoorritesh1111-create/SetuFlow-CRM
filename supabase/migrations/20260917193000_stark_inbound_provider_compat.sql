-- Backward-compatible provider routing for links already using ?source=indiamart/interakt.
-- New UI uses p_provider independently, while p_source remains the channel filter.
...
as $function$
  with base as materialized (
    select
      ...
      s.setu_assigned_name, s.qualification_score
