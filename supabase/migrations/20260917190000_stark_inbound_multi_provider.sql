-- Expand Stark Packmate's inbound workspace to support both Interakt and IndiaMART.
-- The existing p_source argument remains backwards-compatible for CTWA/Instagram/WhatsApp
-- and additionally accepts interakt/indiamart as provider selectors.
...
as $function$
  with base as materialized (
    ...
    where s.organization_id = p_organization_id
      ...
      and (
        coalesce(p_source, 'all') not in ('interakt', 'indiamart')
        or s.source_provider = p_source
      )
