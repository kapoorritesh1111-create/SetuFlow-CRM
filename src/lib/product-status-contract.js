...
export const sprintFocus = {
    ...
    title: "Sprint 3 remains formally closed on the deployed Leads baseline, and Sprint 4 quote-builder core is now formally closed too: the live Product, Pricing, Terms, Review, and Send builder is in place with edit continuity, version visibility, exact-target remediation, return-loop continuity, explicit blocked-versus-caution-versus-ready checkpoint decisions, footer rationale, real submit enforcement, final-step submit locking, blocked-submit handoff, and caution confirmation all landed without jumping ahead into Sprint 5 trust-layer work.",
    nextAction: "Keep Sprint 4 formally closed in the development surfaces, preserve the build-safe baseline, and do not start Sprint 5 implementation until the next trust-layer lane is explicitly approved. The next sequenced work is Sprint 5 trust-layer planning, not another hidden Sprint 4 batch.",
    flow: LOCKED_PRODUCT_FLOW.join(" → "),
};
export const readinessSummary = {
    status: "Deployment verified",
    buildStatus: "The latest production build completed successfully, generated all static pages, finalized optimization, and deployed without a confirmed blocker. Local build discipline still matters, but deployment proof is now current and real.",
    driftRisk: "Controlled because the development pages, workflow state, and successful deployment proof now match. Keep future workflow changes paired with development-page updates so the repo does not drift again.",
    blockers: "No confirmed build blockers. Keep experimental.webpackBuildWorker = false in place until a future real build proves it is safe to remove.",
};
export const planningSurfaces = [
    {
        id: "development-home",
        ...
        status: "done",
        focus: "Keep the repo speaking one sprint timeline again: Sprint 3 closed, Sprint 4 closed, and Sprint 5 still locked.",
    },
    {
        id: "master-plan",
        ...
        status: "done",
        focus: "Preserve the roadmap order while showing clearly that Sprint 3 is closed, Sprint 4 is formally complete, and Sprint 5 remains the next locked lane.",
    },
    {
        id: "readiness",
    ...
    },
    {
        ...
        status: "done",
        focus: "Keep buyer-readiness honest instead of implying the overall roadmap is finished: Sprint 4 quote-builder core is now complete, while Sprint 5 trust-layer proof and later buyer-facing validation remain explicitly sequenced behind it.",
    },
    {
        id: "backlog",
...
export const readinessAreas = [
    ...
    },
    {
        ...
        summary: "The successful deployment does not mean the full rework is buyer-ready yet. Sprint 4 quote-builder core is now complete in the repo, while Sprint 5 trust layers, end-to-end buyer QA, and later buyer-facing proof still remain sequenced work.",
        status: "in-progress",
    },
    {
...
export const checklistItems = [
    ...
    },
    {
        ...
        label: "Development pages now show Sprint 3 closed and Sprint 4 formally closed",
    ...
    },
    {
        id: "sprint-3-entry",
        area: "Next phase",
        label: "Sprint 4 quote-builder readiness-triage batch is active and visible",
        note: "The active phase is the next Quote builder core batch after checkpoint re-entry continuity: Review and Send now make checkpoint decisions explicit as blocked, caution, or ready while preserving the same exact-target continuity and without reopening Sprint 3 or jumping to trust-layer locking.",
        status: "in-progress",
    },
];
export const roadmapMilestones = [
    ...
    },
    {
        ...
        summary: "Keep the guided quote-builder sequence truthful and extend the live workspace by keeping exact remediation loops visible again after users return to the originating review or send checkpoint.",
        badgeLabel: "Next",
        status: "in-progress",
        ...
        outcomes: [
            ...
            "Review and send remediation now lands users on the exact field or pricing line that still needs work inside the same builder, returns directly to the originating checkpoint, keeps that checkpoint loop visible after users return, and now turns checkpoint guidance into aligned continue-and-save actions tied to the explicit blocked-versus-caution-versus-ready decision state, with the leading reason now visible in the footer at the moment of action and enforced on the actual submit path, with save/create now locked to the Send checkpoint itself and blocked submit now handing users directly into the leading exact fix target.",
        ],
    },
    {
...
export const backlogSections = [
    {
        ...
        sprint: "Sprint 3",
        badgeLabel: "Done",
        summary: "Sprint 2 is complete and Sprint 3 is now formally closed. The next lane is the sequenced buyer-ready work that follows Lead simplification, not architecture drift, not module sprawl, and not optional redesign work.",
        description: "Sprint 3 is now closed on the deployed quote-first Leads baseline. Preserve this narrowed workspace, keep Create Quote dominant, keep support guidance collapsed into the quote-prep lane, and do not reopen closed simplification work unless a real blocker proves the baseline wrong.",
        status: "done",
        items: [
            {
    ...
    },
    {
        ...
        heading: "Quote builder is complete, while trust layers and Orders depth remain sequenced behind it",
        sprint: "Sprints 4-6",
        badgeLabel: "Next",
        summary: "Sprint 4 quote-builder core is now complete, and the next commercial and operational work stays visible in order behind it.",
        description: "This protects the plan from inventing extra Sprint 4 work or skipping directly into trust-layer or order-depth implementation before Sprint 5 is intentionally opened.",
        status: "next",
        items: [
            {
...
export const buyerReadySections = [
    {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                note: "The next guided batch is now underway: the live quote draft already follows Product, Pricing, Terms, Review, and Send, workspace guidance is live, edit continuity is step-aware, pricing-risk cues now stay visible inside review and send, builder-side version continuity is now visible before save or send, pricing lines now surface readiness issues plus quick-fix actions, Review/Send point to the exact field or pricing line that still needs work, and after users return from that exact fix the originating checkpoint now keeps the same loop visible with reopen-or-clear actions, and Review/Send now keep that explicit blocked-versus-caution-versus-ready action state plus its leading reason visible in the footer while the actual submit path now enforces blocked checkpoints and keeps save/create locked to the Send checkpoint, with blocked submit now reopening the leading exact fix target, while caution-level send posture now requires an explicit confirmation before save/create can continue before deeper trust work lands later.",
                status: "in-progress",
            },
            {
