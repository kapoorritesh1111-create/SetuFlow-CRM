              ...
              <aside className="absolute bottom-0 right-0 top-0 flex w-full max-w-[440px] flex-col border-l border-slate-200 bg-white shadow-2xl">
                ...
                <form action={updatePipeline} className="flex flex-1 flex-col overflow-hidden">
                  ...
                  <div className="flex-1 space-y-4 overflow-y-auto px-6 py-5">
                    ...
                    <label className="flex items-center gap-2 rounded-[9px] border border-slate-200 bg-slate-50 px-2.5 py-2 text-sm font-semibold text-slate-700"><input type="checkbox" name="is_default" defaultChecked={pipeline.is_default ?? false} /> Default pipeline</label>
                  </div>
                  <div className="flex items-center justify-end gap-2 border-t border-slate-100 px-6 py-4">
                    <a href="#stages-top" className={secondaryButtonClass}>Cancel</a>
        ...
        <aside className="absolute bottom-0 right-0 top-0 flex w-full max-w-[440px] flex-col border-l border-slate-200 bg-white shadow-2xl">
          ...
          <form action={createPipeline} className="flex flex-1 flex-col overflow-hidden">
            <div className="flex-1 space-y-4 overflow-y-auto px-6 py-5">
              ...
              <label className="flex items-center gap-2 rounded-[9px] border border-slate-200 bg-slate-50 px-2.5 py-2 text-sm font-semibold text-slate-700"><input type="checkbox" name="is_default" /> Default pipeline</label>
            </div>
            <div className="flex items-center justify-end gap-2 border-t border-slate-100 px-6 py-4">
              <a href="#stages-top" className={secondaryButtonClass}>Cancel</a>
            ...
            <aside className="absolute bottom-0 right-0 top-0 flex w-full max-w-[440px] flex-col border-l border-slate-200 bg-white shadow-2xl">
              ...
              <form action={updateNextStep} className="flex flex-1 flex-col overflow-hidden">
                ...
                <div className="flex-1 space-y-4 overflow-y-auto px-6 py-5">
                  ...
                  <label className="flex items-center gap-2 rounded-[9px] border border-slate-200 bg-slate-50 px-2.5 py-2 text-sm font-semibold text-slate-700"><input type="checkbox" name="is_active" defaultChecked={step.is_active ?? true} /> Active</label>
                </div>
                <div className="flex items-center justify-end gap-2 border-t border-slate-100 px-6 py-4">
                  <a href="#stages-top" className={secondaryButtonClass}>Cancel</a>
