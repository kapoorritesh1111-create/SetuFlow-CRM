          ...
          <div className="flex flex-col gap-2 xl:flex-row xl:items-center xl:justify-between">
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-3">
                <h1 className="text-2xl font-semibold tracking-[-0.03em] text-slate-950 dark:text-slate-50">{title}</h1>
              </div>
              {description ? <p className="mt-1 max-w-xl text-[13px] leading-5 text-slate-600 dark:text-slate-300">{description}</p> : null}
            </div>
