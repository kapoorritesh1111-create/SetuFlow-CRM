...
export async function TrialWorkspaceBanner({ organizationId }: { organizationId: string }) {
  ...
  return (
    <div className="border-b border-amber-200 bg-gradient-to-r from-amber-50 via-orange-50 to-white px-4 py-3 text-sm text-amber-950">
      <div className="mx-auto flex max-w-7xl flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="text-xs font-extrabold uppercase tracking-[0.18em] text-amber-700">Guided trial workspace</p>
