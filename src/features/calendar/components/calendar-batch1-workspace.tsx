...
export function CalendarBatchOneWorkspace({ userName }: { userName: string }) {
  ...
  useEffect(() => {
    ...
    setSelected(target);
    setDraftStart(null);
    setCursor(new Date(target.starts_at));
