...
const LeadsToolbar: React.FC<LeadsToolbarProps> = ({
  ...
  return (
    <section className="space-y-3">
      <div className="rounded-[1.7rem] bg-[linear-gradient(90deg,#23458f_0%,#2f58bc_65%,#3567da_100%)] p-3 shadow-[0_16px_34px_rgba(37,99,235,0.16)] sm:p-3.5">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            {savedViews.map((view) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'shrink-0 rounded-[1.05rem] border px-3 py-2 text-sm font-semibold transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/80',
                    active
          ...
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(170px,200px)_auto_auto] sm:items-center">
            <ToolbarSelect
              ...
              className="h-10 rounded-[1.05rem] border-white/20 bg-white/18 px-3 text-sm text-white shadow-none backdrop-blur placeholder:text-white/75 focus:border-white/40 focus:bg-white/22 focus:shadow-[0_0_0_3px_rgba(255,255,255,0.12)] [&>option]:text-slate-900"
            >
            ...
            <button
              type="button"
              onClick={onQuickAdd}
              className="inline-flex min-h-10 items-center justify-center rounded-[1.05rem] border border-white/20 bg-white/16 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/22 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/80"
            >
              + Quick Lead
            </button>
            <button
              type="button"
              onClick={onFullAdd}
              className="inline-flex min-h-10 items-center justify-center rounded-[1.05rem] border border-white/70 bg-white px-4 py-2 text-sm font-semibold text-slate-900 shadow-[0_10px_24px_rgba(15,23,42,0.12)] transition hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/80"
            >
              New Lead
            </button>
          </div>
      ...
      <div className="rounded-[1.45rem] border border-white/85 bg-white/96 p-3 shadow-[0_14px_28px_rgba(15,23,42,0.06)] ring-1 ring-slate-950/[0.03] backdrop-blur">
          ...
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
            <div className="min-w-0 flex-1">
              <ToolbarSearchInput
                ...
                className="h-10 rounded-[1rem] border-slate-200 bg-slate-50/90"
              />
            </div>
