              ...
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                ...
                <div className="mb-4 rounded-2xl border border-slate-200 bg-white p-4 text-sm text-slate-600">
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    <Link href={`/leads/${lead?.id}/quote`} className="rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 hover:border-brand-200 hover:text-brand-700">Open quote workspace</Link>
