...
export function toLeadProfileSnapshot(data: LeadProfileData): LeadProfileSnapshot {
  ...
  return {
    lead: {
      ...
      phoneSecondary: data.lead?.phone_secondary ?? null,
      phoneCountryCode: data.lead?.phone_country_code ?? null,
      phoneSecondaryCountryCode: data.lead?.phone_secondary_country_code ?? null,
