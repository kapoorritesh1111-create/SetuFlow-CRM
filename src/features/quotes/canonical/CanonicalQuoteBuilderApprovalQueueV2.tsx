    ...
    <div className="space-y-4 pb-20">
      ...
      <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_300px]">
        <div className="rounded-[1.25rem] border border-amber-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm font-semibold leading-6 text-slate-600">This quote version is already in approval review. Use the real Approval Queue to approve or reject the request.</p>
          ...
          <div className="mt-5 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-5 text-amber-900">
            ...
            <div className="flex gap-2">
              ...
              <Link href={approvalHref} className="rounded-xl border border-blue-200 bg-white px-4 py-3 text-sm font-black text-blue-700">Open Approval Queue</Link>
...
export default function CanonicalQuoteBuilderApprovalQueueV2(props: Props) {
