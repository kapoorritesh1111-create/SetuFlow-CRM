        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-1 md:flex" aria-label="Main navigation">
            ...
            <div className="ml-3 flex items-center gap-2">
              <LanguageSelector />
              <Link href="/roi-calculator" className={`rounded-full border px-5 py-2 text-[13px] font-semibold transition hover:-translate-y-0.5 ${isActive('/roi-calculator') ? 'border-[#108477] bg-teal-50 text-[#108477]' : 'border-[#108477]/25 bg-white text-[#108477] hover:bg-[#eef6fb]'}`}>ROI Calculator</Link>
