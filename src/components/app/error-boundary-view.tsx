...
export function ErrorBoundaryView({
  ...
  description = 'SETU Flow could not load this screen. Try again or return to a stable workspace.',
  reset,
  homeHref = '/dashboard',
  ...
  return (
    <div className="flex min-h-[50vh] items-center justify-center px-6 py-10">
      <div className={`w-full max-w-2xl ${workspaceHeroClass} border-rose-200/90 p-8 dark:border-rose-900/60`}>
        <p className="text-sm font-semibold uppercase tracking-wide text-rose-700 dark:text-rose-300">{eyebrow}</p>
