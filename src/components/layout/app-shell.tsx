...
const NOTICE_COPY: Record<string, ShellNotice> = {
  ...
  'quote-approved': { title: 'Quote approval cleared', description: 'The quote-only adjustment was approved and the send gate can continue.', tone: 'success' },
  'quote-rejected': { title: 'Quote revision requested', description: 'The quote remains blocked until the requested revision is made.', tone: 'warning' },
  'quote-approval-error': { title: 'Quote approval failed', description: 'The approval action did not complete. Check permissions and try again.', tone: 'danger' },
  'quote-rejection-error': { title: 'Quote rejection failed', description: 'The rejection action did not complete. Check permissions and try again.', tone: 'danger' },
  'quote-order-error': { title: 'Order handoff failed', description: 'The quote was not converted into an order. Check permissions and Supabase contract RPC.', tone: 'danger' },
  'quote-order-missing': { title: 'Quote missing', description: 'Select a quote before creating an order handoff.', tone: 'warning' },
