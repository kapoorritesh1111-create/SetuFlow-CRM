...
export function MobileTabBar() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-[250] border-t border-slate-200 bg-white/95 shadow-[0_-12px_30px_rgba(15,23,42,0.10)] backdrop-blur md:hidden"
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              ...
              className={cn(
                'relative flex min-h-11 flex-1 flex-col items-center justify-center gap-1 text-[10px] font-semibold transition',
                active ? 'text-[#0c7fff]' : 'text-slate-500 hover:text-slate-900',
              )}
            >
