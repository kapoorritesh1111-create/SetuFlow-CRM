...
export function InAppNotificationCenter({ organizationId, userId }: { organizationId: string; userId: string }) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-4 bottom-[calc(96px+env(safe-area-inset-bottom))] z-[340] flex flex-col items-end gap-3 md:inset-x-auto md:bottom-auto md:right-[5.85rem] md:top-4 md:w-auto">
