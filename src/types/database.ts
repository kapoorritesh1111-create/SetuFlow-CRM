...
type ProductVariantRow = { id: string; product_id: string; name: string; hs_code_id: string | null; created_at: string };
...
type LeadProductInterestRow = { id: string; lead_id: string; product_id: string; label: string | null; created_at: string };
