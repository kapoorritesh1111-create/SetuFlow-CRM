...
type QuoteRow = { id: string; organization_id: string; lead_id: string; rfq_id: string | null; created_by: string | null; status: string; currency: string | null; notes: string | null; notes_internal?: string | null; quote_number?: string | null; current_version_id?: string | null; pricing_basis?: string | null; display_currency?: string | null; approval_required?: boolean; approved_at?: string | null; approved_by?: string | null; created_at: string; updated_at: string };
