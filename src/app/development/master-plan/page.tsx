          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-4xl">
              ...
              <p className="mt-5 text-lg leading-8 text-slate-600">
                Setu Flow is built in disciplined sprints, each one deepening the core commercial flow without adding scope outside it. Closed sprints stay closed. Active sprints are tracked here. The roadmap shows what comes next and in what order.
              </p>
            </div>
