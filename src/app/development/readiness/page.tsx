    ...
    <SiteShell>
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <section className="rounded-[2rem] border border-[#1F487C]/10 bg-white p-8 shadow-[0_20px_60px_rgba(31,72,124,0.08)] lg:p-10">
          ...
          <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">Sprint 1 readiness is now shown honestly as {sprintProgress.percentLabel}, with the original step sequence restored and future sprints visible but still inactive.</h1>
