        ...
        <section className="rounded-[2rem] border border-[#1F487C]/10 bg-white p-8 shadow-[0_20px_60px_rgba(31,72,124,0.08)] lg:p-10">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-4xl">
              ...
              <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">One backlog surface inside the development workplace, with Sprint 2 complete, Sprint 3 ready next, and deeper module work sequenced behind it.</h1>
            ...
            <div className="rounded-[1.75rem] border border-[#1F487C]/10 bg-[linear-gradient(135deg,#1F487C_0%,#359F91_100%)] p-6 text-white lg:max-w-sm">
              ...
              <p className="mt-4 text-sm leading-7 text-white/85">Sprint 3 is the next approved lane. The deeper roadmap stays visible here so sequencing does not drift again.</p>
            </div>
          </div>
