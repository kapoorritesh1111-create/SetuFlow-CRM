    ...
    <SiteShell>
      <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        <section className="rounded-[2rem] border border-[#1F487C]/10 bg-white p-8 shadow-[0_20px_60px_rgba(31,72,124,0.08)] lg:p-10">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-4xl">
              ...
              <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">One backlog surface inside the development workplace, with Sprint 3 formally closed on a deployed baseline, Sprint 4 quote-builder batch 10 active, and later buyer-ready work still sequenced clearly behind it.</h1>
            ...
            <div className="rounded-[1.75rem] border border-[#1F487C]/10 bg-[linear-gradient(135deg,#1F487C_0%,#359F91_100%)] p-6 text-white lg:max-w-sm">
              ...
              <p className="mt-4 text-sm leading-7 text-white/85">Sprint 3 is now closed. Sprint 4 quote-builder batch 9 is active, and buyer-ready gaps are tracked explicitly so later work starts from the shipped Leads baseline instead of reopening closed simplification work.</p>
            </div>
          </div>
        ...
        <section className="mt-10 grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-[2rem] border border-[#1F487C]/10 bg-white p-8 shadow-[0_20px_60px_rgba(31,72,124,0.08)]">
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#359F91]">Why backlog stays here</p>
