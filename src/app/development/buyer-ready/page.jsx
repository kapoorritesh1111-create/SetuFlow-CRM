          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-4xl">
              ...
              <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">
                ...
                guidance, step-aware edit continuity, live pricing-risk cues,
                version continuity inside review/send, line-level pricing readiness cues, exact-target review/send remediation,
                return-to-checkpoint continuity, checkpoint re-entry continuity, footer-level action rationale, submit enforcement, Send-checkpoint-only save/create, blocked-submit handoff, and caution confirmation.
              </h1>
              <p className="mt-5 text-lg leading-8 text-slate-600">
                Use this tab to keep buyer-facing readiness honest. A successful
                deployment proves the baseline is live; it does not by itself
                mean the rework is complete enough for buyer walkthroughs,
                signoff, or external confidence.
              </p>
            </div>
            <div className="rounded-[1.75rem] border border-[#1F487C]/10 bg-[linear-gradient(135deg,#1F487C_0%,#359F91_100%)] p-6 text-white lg:max-w-sm">
              ...
              <p className="mt-4 text-sm leading-7 text-white/85">
                ...
                remaining approved rework in order before claiming buyer-facing
                completion.
              </p>
            </div>
          </div>
