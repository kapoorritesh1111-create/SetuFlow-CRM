...
type CatalogDatabase = Omit<Database, 'public'> & { public: Omit<Database['public'], 'Tables'> & { Tables: Omit<Database['public']['Tables'], 'product_categories' | 'products' | 'product_variants' | 'pricing_rule_sets' | 'product_pricing_rules' | 'import_runs' | 'import_issues' | 'audit_logs'> & { product_categories: Table<LiveRow, LiveRecord>; products: Table<LiveRow, LiveRecord>; product_variants: Table<LiveRow, LiveRecord>; pricing_rule_sets: Table<LiveRow, LiveRecord>; product_pricing_rules: Table<LiveRow, LiveRecord>; import_runs: Table<LiveRow, LiveRecord>; import_issues: Table<LiveRow, LiveRecord>; audit_logs: Table<LiveRow, LiveRecord> } } };
