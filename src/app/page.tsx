  ...
  return (
    <SiteShell>
      <main className="overflow-hidden bg-white" style={{ fontFamily: "'Plus Jakarta Sans', var(--font-jakarta), ui-sans-serif, system-ui, -apple-system, sans-serif" }}>
        ...
        {/* ══════════════════════════════════════════════════════════
            HERO — rebuilt for category-leader positioning
            Mobile: headline first, image last, minimal padding
            Desktop: commanding two-column with immersive dashboard
        ══════════════════════════════════════════════════════════ */}
        <section className="relative overflow-hidden bg-[#061c2e] text-white">

          {/* Deep directional gradient — more dramatic than before */}
          ...
          {/* Subtle grid — kept but slightly more visible */}
          ...
          {/* Thin luminous line across the top of section */}
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-0 lg:grid-cols-[1fr_1.08fr] lg:items-center lg:gap-12">
              ...
              <div className="pb-10 pt-12 sm:pt-14 lg:py-28 setu-reveal">
                ...
                {/* Headline — much larger on desktop, readable on mobile */}
                ...
                <p className="mt-5 max-w-lg text-[15px] leading-7 text-white/68 sm:mt-6 sm:text-base sm:leading-8 lg:text-[17px]">
                  From first contact to final shipment, Setu Flow runs your entire trade operation in one calm, connected system.
                </p>
                ...
                <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:gap-4">
                  <a
                    href="#book-demo"
                    className="flex items-center justify-center rounded-full bg-white px-7 py-3.5 text-sm font-bold text-[#061c2e] shadow-[0_16px_48px_rgba(125,226,210,0.22)] transition hover:-translate-y-0.5 hover:shadow-[0_20px_52px_rgba(125,226,210,0.30)]"
                  >
                    Book a demo
                  </a>
                  <a
                    href="#platform"
                    className="flex items-center justify-center rounded-full border border-white/22 bg-white/8 px-7 py-3.5 text-sm font-semibold text-white backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/14 hover:border-white/30"
                  >
                    Explore platform
                  </a>
                </div>
                ...
                <div className="relative rounded-[2.2rem] border border-white/16 bg-white/8 p-2.5 shadow-[0_40px_120px_rgba(0,0,0,0.50),0_0_0_1px_rgba(255,255,255,0.06)] backdrop-blur-sm lg:rotate-[-0.8deg]">
                  <div className="rounded-[1.75rem] border border-white/10 bg-[#e8f4f8] p-1.5">
                    <Image
                      ...
                      alt="Setu Flow command center — trade pipeline, market coverage and execution view"
                      width={1628}
                      height={1032}
                      priority
                  ...
                  <div className="absolute -right-4 top-8 hidden rounded-2xl border border-[#7de2d2]/28 bg-[#062840]/92 px-4 py-3.5 shadow-[0_16px_42px_rgba(0,0,0,0.45)] backdrop-blur-sm lg:block">
                    <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#7de2d2]">Next best action</p>
                    <p className="mt-1.5 text-[15px] font-bold">34 follow-ups due</p>
                  </div>
                </div>
              </div>
          ...
          {/* ── Bottom edge: stat bar inside the dark hero ── */}
          ...
          <div className="mx-auto mt-12 grid max-w-7xl gap-6 lg:grid-cols-3">
            {pricing.map((plan, index) => (
              <div key={plan.name} className={`relative overflow-hidden rounded-[1.75rem] border bg-white shadow-[0_22px_70px_rgba(31,72,124,0.09)] setu-reveal setu-delay-${index + 1} ${plan.featured ? 'border-[#0c7fff] lg:-translate-y-3' : 'border-[#1F487C]/10'}`}>
                {plan.featured && <div className="absolute right-6 top-6 rounded-full bg-[#7de2d2]/15 px-4 py-2 text-[10px] font-semibold uppercase tracking-[0.16em] text-[#7de2d2]">Most popular</div>}
