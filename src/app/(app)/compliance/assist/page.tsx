...
export default async function ComplianceAssistPage({ searchParams }: { searchParams?: SearchParams }) {
  ...
  return <div className="mx-auto max-w-5xl space-y-4">
    <section className="rounded-panel border border-slate-200 bg-white p-5 shadow-[0_14px_36px_rgba(15,23,42,0.07)]">
    ...
    <section className={`rounded-card border p-5 shadow-sm ${toneClasses(quoteDoc.tone)}`}>
