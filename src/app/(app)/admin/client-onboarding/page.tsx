...
import { createWorkspaceFromOnboardingDraft, resendClientOnboardingNotification, updateClientOnboardingStatus } from '@/features/client-onboarding/server/actions';
...
function RequestCard({ request, countryCount }: { request: OnboardingRequest; countryCount: number }) {
  ...
  const invitePrepared = request.status === 'admin_invited' || request.status === 'live';
