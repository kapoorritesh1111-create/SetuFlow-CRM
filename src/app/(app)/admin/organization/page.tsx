        ...
        <div className="relative p-6 text-white md:p-8">
          ...
          <div className="relative grid gap-6 lg:grid-cols-[150px_1fr_auto] lg:items-center">
            ...
            <div>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3 text-sm font-bold text-white/85"><span>{orgProfile.slug ? `${orgProfile.slug}.setuflowcrm.com` : 'Workspace slug pending'}</span><span>{defaultCountry ? `${iso2ToFlagEmoji(defaultCountry.iso2_code)} ${defaultCountry.name}` : 'Country pending'}</span><span>{orgProfile.default_currency ?? 'USD'} default currency</span><span>{myRoleLabel}</span></div>
