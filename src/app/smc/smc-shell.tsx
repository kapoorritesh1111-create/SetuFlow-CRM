...
const NAV_GROUPS: NavGroup[] = [
  ...
  { key: "delivery", label: "Delivery", icon: "GrpDelivery", items: [
    ...
    { id: "agents", path: "/smc/agents", icon: "Agent", label: "Agents" },
  ...
  { key: "growth", label: "Growth", icon: "GrpGrowth", items: [
    ...
    { id: "followups", path: "/smc/leads/followups", icon: "Bell", label: "Follow-up Queue" },
    { id: "clients", path: "/smc/clients", icon: "Users", label: "Client Orgs" },
    { id: "revenue", path: "/smc/revenue", icon: "$", label: "Revenue" },
    { id: "mail-usage", path: "/smc/mail-usage", icon: "Mail", label: "Mail Usage" },
  ...
  { key: "config", label: "Config", icon: "GrpConfig", items: [
    ...
    { id: "access", path: "/smc/settings/access", icon: "Users", label: "Team Access" },
  ] },
];
...
const SVG_ICONS: Record<string, string> = {
  ...
  "Mail": "M3 6.75A1.75 1.75 0 014.75 5h14.5A1.75 1.75 0 0121 6.75v10.5A1.75 1.75 0 0119.25 19H4.75A1.75 1.75 0 013 17.25V6.75zm1 .25 8 5.5L20 7",
  ...
  "Agent": "M12 3l1.9 5.8L20 10l-5 3.6L16.5 20 12 16.4 7.5 20 9 13.6 4 10l6.1-1.2L12 3Z",
...
export function SmcShell({ children }: { children: ReactNode }) {
  ...
  useEffect(() => { const f = () => fetch("/api/smc/guest-unread").then((r) => r.json()).then((d) => setGuestUnread(d.awaiting || 0)).catch(() => {}); f(); const t = setInterval(f, 15000); return () => clearInterval(t); }, []);
  useEffect(() => {
