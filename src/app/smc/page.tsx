...
async function getStats() {
  ...
  const [issuesRes, leadsRes, orgsRes] = await Promise.all([
    ...
    supabase.from('client_onboarding_requests').select('id, pipeline_stage'),
  ...
  return {
    ...
    qualified: (leadsRes.data ?? []).filter(l => l.pipeline_stage === 'qualified').length,
    converted: (leadsRes.data ?? []).filter(l => l.pipeline_stage === 'converted').length,
  };
}
            ...
            <div className="smc-dc-t">
              <div className="smc-dc-i" style={{ background: card.color, color: card.iconColor }}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16">
                  ...
                  {card.icon === 'user-plus' && <><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></>}
                  {card.icon === 'users' && <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/></>}
                  {card.icon === 'cloud' && <><polyline points="16 16 12 12 8 16"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3"/></>}
                  {card.icon === 'triangle' && <><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></>}
                  {card.icon === 'dollar' && <><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></>}
                </svg>
              </div>
