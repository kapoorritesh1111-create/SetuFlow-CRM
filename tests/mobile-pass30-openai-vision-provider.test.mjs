...
test('PASS30 supports OpenAI Vision direct photo provider', () => {
...
test('PASS30 readiness reports openai-vision active provider separately', () => {
...
test('PASS30 production docs and env example instruct investor demo provider', () => {
