...
test('PASS32 scan UX keeps scan progress visible after camera/file picker closes', () => {
...
test('PASS32 scan success uses customer-safe copy without field dump duplication', () => {
...
test('PASS32 footer shows only loading scan state so success is not duplicated below form', () => {
