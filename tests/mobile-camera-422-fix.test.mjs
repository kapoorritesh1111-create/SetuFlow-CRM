...
test('mobile camera upload baseline camera photos are always transcoded to JPEG before server upload', () => {
...
test('mobile camera upload baseline OpenAI Vision has a chat vision fallback and high detail image reading', () => {
...
test('mobile camera upload baseline scan progress is visible in the sticky lead footer', () => {
