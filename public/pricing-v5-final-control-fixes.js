...
function wireConstructions(){const p=page();if(!p||!/Constructions/i.test(title()))return;
 qa('button',p).forEach(b=>{const t=(b.textContent||'').trim();
