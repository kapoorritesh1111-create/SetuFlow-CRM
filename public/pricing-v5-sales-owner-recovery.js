...
let lastPage=false,initializedFor='',tickTimer=null;
...
function scheduleTick(delay=60){if(tickTimer)clearTimeout(tickTimer);tickTimer=setTimeout(()=>{tickTimer=null;tick()},delay)}
